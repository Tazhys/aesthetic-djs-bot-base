...
module.exports = async function (message) {
    ...
    if (found) {
        ...
        if (['string', 'object'].includes(typeof result) || result instanceof EmbedBuilder) {
            ...
            try {
                ...
                return channel.send({ content: `\`${dateNow}\` | I'm not sure why, but I ran into an error. Please contact developers for more details ^-^` });
            }
        }
    }
}
